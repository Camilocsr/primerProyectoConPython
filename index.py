...
class Product:
    ...
    def __init__(self, window):
        ...
        self.wind.iconbitmap('images/csr.ico')
        self.wind.config(bg= 'darkmagenta')

        # Creating a Frame Container 
        frame = LabelFrame(self.wind, text = 'Reistre un nuevo producto')
        frame.grid(row = 0, column = 0, columnspan = 5, pady = 50)
        ...
        # Button Add Product 
        ttk.Button(frame, text = 'Agregar el producto', command = self.add_product).grid(row = 3, columnspan = 2, sticky = W + E)

        # Output Messages 
        self.message = Label(text = '', fg = 'darkblue')
    ...
    def add_product(self):
        if self.validation():
            ...
            self.message['text'] = 'Se requiere un nombre y precio del producto a agregar.'
        self.get_products()
    ...
    def delete_product(self):
        ...
        self.message['text'] = 'Producto {} A sido eleminado con exito'.format(name)
        self.get_products()
    ...
    def edit_records(self, new_name, name, new_price, old_price):
        ...
        self.message['text'] = 'Producto {} editado'.format(name)
        self.get_products()
